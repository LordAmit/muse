...
public class TaintOperatorTest {
	private ASTRewrite rewriter;
	private String source;
	private CompilationUnit root;
	private MethodDeclaration node;
	private ArrayList<SourceNodeChangeContainers> nodeChanges;
	private TaintOperator taintOperator;
	private TaintSchema taintSchema;
	...
	public void insertion_at_null_declaration_node() {
		...
		taintOperator = new TaintOperator(rewriter, nodeChanges);
		String output = taintOperator.InsertChanges().toString();
