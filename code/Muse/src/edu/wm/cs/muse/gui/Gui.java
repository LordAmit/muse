...
public class Gui extends Application {
	...
	/**
	 * This method has to be implemented because Gui "extends" Application (for
	 * JavaFX functionality).
	 * 
	 * Sets the local window variable and opens the application to the title screen
	 */
	@Override
	...
	///////////////////////////////////// TITLE SCENE CODE///////////////////////////////////////////////
	/**
	 * Creates the title scene. Contents: Buttons allowing user to run muse with an
	 * existing config file, or to create a new one mSE title
	 * 
	 * @param stage
	 */
	private void goToTitleScene(Stage stage) {
		...
		createButtons(stage); // initializes 2 buttons and gives each a handler for running code on being
								// clicked
		createTitleText();
	...
	/**
	 * Creates the Buttons for: 1. Running muse with an existing configuration file
	 * (oldConfigBtn) 2. Creating a new configuration file in a new window
	 * (makeConfigBtn)
	 */
	...
	private GridPane createGridPane(Stage stage) {
		...
		operatorSelections.getItems().addAll("SCOPESOURCE", "SCOPESINK", "TAINTSOURCE", "TAINTSINK",
				"COMPLEXREACHABILITY", "REACHABILITY");
		...
		// Every time the mutate checkbox is clicked, disable/enable corresponding text fields and remove their errored border
	...
	/**
	 * Changes the scene to the one with a progress bar. Gives information as Muse
	 * runs. TODO: Implement rest of layout TODO: Sync progress bar progress to Muse
	 * progress 
	 * @param stage
	 */
	...
	/**
	 * Changes scene to final screen that shows where log file is. This screen is
	 * only visited if muse ran successfully. If there was an error, it will take
	 * the user to the error scene instead
	 * TODO: Implement goToSuccessfulRunScene function
	 */
	...
	/**
	 * * If muse crashes or there is an error, the user is taken to this scene. this
	 * scene gives information about why muse crashed. Might give suggestions about
