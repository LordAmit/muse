...
public class TaintSinkSchemaTest {
  ...
  private void prepare_test_files(ComponentType component) throws FileNotFoundException, IOException {
    ...
    switch (component) {
    case STATICMETHOD:
      content = FileUtility.readSourceFile("src/test/java/input/taintSinkInput/taint_sink_sample_static_method.txt").toString();
      break;

    case SWITCH:
      content = FileUtility.readSourceFile("src/test/java/input/taintSinkInput/taint_sink_sample_switch.txt").toString();
      break;
      
    case SWITCHMETHOD:
      content = FileUtility.readSourceFile("src/test/java/input/taintSinkInput/taint_sink_sample_switch_method.txt").toString();
      break;

    case TRY:
      content = FileUtility.readSourceFile("src/test/java/input/taintSinkInput/taint_sink_sample_try.txt").toString();
      break;
    
    case TRYMETHOD:
      content = FileUtility.readSourceFile("src/test/java/input/taintSinkInput/taint_sink_sample_try_method.txt").toString();
      break;
      
    case ENUMMETHOD:
        content = FileUtility.readSourceFile("src/test/java/input/sink_sample_enum_method.txt").toString();
        break;
    }
