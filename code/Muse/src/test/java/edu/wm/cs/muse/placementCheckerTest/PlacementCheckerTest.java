...
public class PlacementCheckerTest extends Placementchecker {
	...
	*/
	...
	public void test_getTempFileMethod_sample_HelloWorld() throws FileNotFoundException, IOException {
		...
		File temp_file = checker.getTempFile(root, rewriter, "src/test/java/input/sample_helloWorld.txt");

		assertEquals(true,FileUtility.testFileEquality(temp_file, new File("src/test/java/input/sample_helloWorld.txt")));
	...
	public void test_getTempFileMethod_hello_world_sink() throws FileNotFoundException, IOException {
		...
		prepare_test_files(OperatorType.SCOPESINK, 1);
		rewriter = ASTRewrite.create(root.getAST());
		File temp_file = checker.getTempFile(root, rewriter, "src/test/java/output/sample_hello_world_sink.txt");

		assertEquals(true,FileUtility.testFileEquality(temp_file, new File("src/test/java/output/sample_hello_world_sink.txt")));
	...
	public void test_getTempFileMethod_mulitilevel_class() throws FileNotFoundException, IOException {
		...
		prepare_test_files(OperatorType.SCOPESINK, 1);
		rewriter = ASTRewrite.create(root.getAST());
		File temp_file = checker.getTempFile(root, rewriter, "src/test/java/input/sample_multilevelclass.txt");

		assertEquals(true,FileUtility.testFileEquality(temp_file, new File("src/test/java/input/sample_multilevelclass.txt")));
	...
	public void test_errors_on_errorless_file() throws IOException {
		PlacementCheckerTest checker = new PlacementCheckerTest();
		File temp_file = new File("src/test/java/input/sample_multilevelclass.txt");
	...
	public void test_unreachable_static() throws IOException {
		PlacementCheckerTest checker = new PlacementCheckerTest();
		File temp_file = new File("src/test/java/input/sample_unreachable_static.txt");
	...
	public void test_sample_duplicated_var() throws IOException {
		PlacementCheckerTest checker = new PlacementCheckerTest();
		File temp_file = new File("src/test/java/input/sample_duplicated_variable.txt");
		assertEquals(false,checker.check(temp_file));
	}
	...
	public void test_incompatible_return() throws IOException {
		PlacementCheckerTest checker = new PlacementCheckerTest();
		File temp_file = new File("src/test/java/input/sample_switch_case_no_return.txt");
		assertEquals(false,checker.check(temp_file));
	}
